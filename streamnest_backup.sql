...
--
-- Table structure for table `core_genre`
--

DROP TABLE IF EXISTS `core_genre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `core_genre`
--

LOCK TABLES `core_genre` WRITE;
/*!40000 ALTER TABLE `core_genre` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_genre` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_content_type` VALUES (10,'accounts','profile'),(1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(15,'core','genre'),(12,'movies','comingsoon'),(13,'movies','genre'),(7,'movies','movie'),(11,'series','episode'),(14,'series','genre'),(8,'series','series'),(6,'sessions','session'),(9,'watchlist','watchlistitem');
...
-- Dump completed on 2025-09-23 19:33:37
